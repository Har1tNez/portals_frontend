...
const MultipleSelector = React.forwardRef<MultipleSelectorRef, MultipleSelectorProps>(
    (
        ...
        const [badgeInputValues, setBadgeInputValues] = React.useState<{ [key: string]: string; }>({});

        const handleBadgeInputChanges = (newValue: string, option: string) => {
        ...
        return (
            <Command
                {...commandProps}
                onKeyDown={(e) => {
                    !disableInput && handleKeyDown(e);
                    !disableInput && commandProps?.onKeyDown?.(e);
                }}
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => {
                                            handleBadgeInputChanges(e.target.value, option.value);
                                        }}
                                        value={badgeInputValues[option.value] || ''}
                                        style={{ width: "100px", height: "20px", color: 'white' }}
                                        type="text" id="mrn"
